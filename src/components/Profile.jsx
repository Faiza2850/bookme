...
export const Profile = () => {
  return (
    ...
    <div className='p-10  xl:p-20 xl:pr-40 md:p-8 sm:max-w-3xl max-w-2xl bg-white mx-auto  rounded-xl'>
        ...
        Rides History <img src={bucket} className='mr-2 ml-2' />
        </button>
        ...
        <button className='bg-[#FFCA09] text-black p-2 rounded py-3 font-semibold flex w-60 items-center justify-center '>Make a Booking <FaCalendarPlus className="mr-2 ml-2" /></button>
        <button className='bg-[#FFCA09] text-black p-2 rounded py-3 font-semibold flex w-60 items-center justify-center '>View Bookings <img src={viewbook} className='mr-2 ml-2' /></button>
        </div>
...
<button className='bg-[#FFCA09] text-black p-2 rounded py-3 font-semibold flex w-60 items-center justify-center '>View Quotes <img src={quotes} className='mr-2 ml-2' /></button>
...
remove them here.</p>
<button className='bg-[#FFCA09] text-black p-2 rounded py-3 font-semibold flex w-60 items-center justify-center '>Manage Cards  <FaCreditCard className="mr-2 ml-2" /> </button>
<h4 className='pt-5 font-semibold'>Update Your Details</h4>
        ...
        <div className='flex gap-6'>
        <button className='bg-[#FFCA09] text-black p-2 rounded py-3 font-semibold flex w-60 items-center justify-center '>Log Out <img src={logout} className='mr-2 ml-2' /> </button>
        <button className='bg-[#FFCA09] text-black p-2 rounded py-3 font-semibold flex w-60 items-center justify-center '>Edit Profile <FaPencilAlt className="mr-2 ml-2 " /> </button>
        </div>
    </div>
  )
}
